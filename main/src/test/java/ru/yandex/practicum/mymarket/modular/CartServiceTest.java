...
/*
    ...
    void testItems_Success() {
        ...
        when(cartItemRepository.findCartItems("user")).thenReturn(mockItems); //todo
        Flux<Item> items = cartItemRepository.findCartItems("user"); //todo
    ...
    void testTotal_Success() {
        ...
        when(cartRepository.cartTotal("user")).thenReturn(mockTotal); //todo
        Mono<Long> total = cartRepository.cartTotal("user"); //todo
    ...
    @DisplayName("Продано")
    void testSold() {
        when(cartRepository.sold("user")).thenReturn(Mono.empty()); //todo
